...
After successful generation, the programs plots all figures in the folder Analysis/Figures/3_ShapeFeature_<property>.eps For Circularity, the file name is 3_ShapeFeature_ Circularity.eps (see below) \
