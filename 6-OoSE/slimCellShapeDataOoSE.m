...
% if true is added
function [ CellShapeData_slim ] = slimCellShapeDataOoSE( CellShapeData,scoress, XtraSlim )
CellShapeData_slim.set={};
CellShapeData_slim.point={};
CellShapeData_slim.set.SCORE=CellShapeData.point.SCORE;
CellShapeData_slim.set.Long_D=CellShapeData.set.Long_D;%
N = length(scoress.OoSE_emb);
for i =1:N
    CellShapeData_slim.set.SCORE(i,:) = scoress.OoSE_emb(i,:);
