function [ sum_sk ] = BAM_for_OoSE(trainingCellShapeData, OoSE_frames, new_unique_savedestination )
%BAM_for_OoSE Calculate BAM for additional data to training data
%   
