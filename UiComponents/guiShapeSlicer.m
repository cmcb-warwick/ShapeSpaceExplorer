function varargout = guiShapeSlicer(varargin)
% GUISHAPESLICER MATLAB code for guiShapeSlicer.fig
%      GUISHAPESLICER, by itself, creates a new GUISHAPESLICER or raises the existing
%      singleton*.
%
%      H = GUISHAPESLICER returns the handle to a new GUISHAPESLICER or the handle to
%      the existing singleton*.
%
%      GUISHAPESLICER('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in GUISHAPESLICER.M with the given input arguments.
%
%      GUISHAPESLICER('Property','Value',...) creates a new GUISHAPESLICER or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before guiShapeSlicer_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to guiShapeSlicer_OpeningFcn via varargin.
%
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @guiShapeSlicer_OpeningFcn, ...
                   'gui_OutputFcn',  @guiShapeSlicer_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before guiShapeSlicer is made visible.
function guiShapeSlicer_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to guiShapeSlicer (see VARARGIN)

% Choose default command line output for guiShapeSlicer
...
function varargout = guiShapeSlicer_OutputFcn(hObject, eventdata, handles) 
