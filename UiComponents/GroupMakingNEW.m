function varargout = GroupMakingNEW(varargin)
...
% Last Modified by GUIDE v2.5 22-Nov-2017 10:10:27

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @GroupMakingNEW_OpeningFcn, ...
                   'gui_OutputFcn',  @GroupMakingNEW_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
function GroupMakingNEW_OpeningFcn(hObject, eventdata, handles, varargin)
...
function varargout = GroupMakingNEW_OutputFcn(hObject, eventdata, handles) 
...
fpath= get(handles.edit3, 'String');
if ~exist(fpath, 'dir')
    mode = struct('WindowStyle','non-modal','Interpreter','tex');
    msg = DialogMessages(21);
    errordlg(msg, 'Error', mode);
    return;%
end
%else
...
function  setEditsFields(string1, string2, string3, handles)
...
if exist(fPath, 'dir')
  set(handles.edit3, 'String',fPath);  
end
